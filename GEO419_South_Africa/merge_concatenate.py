...
def main():
    ...
    # raster_folder = "C:/Users/jz199/Documents/Studium/Master/1. Semester\Vorlesungsmitschriften/GEO419 - Pythonprogrammierung Habermeyer/GEO402_Output/"
    ...
    # Output File Name:
    output_file = raster_filename[0:len(raster_filename)-4] + "_combined_density.tif"
#simple_edge_detection
    ...
    # filtered_arr = apply_along_axis.parallel_apply_along_axis(func1d=filter_functions.simple_edge_detection5, arr=arr, axis=0, cores=mp.cpu_count())
    ...
    result = apply_along_axis.parallel_apply_along_axis(func1d=function.combined_density, arr=arr, axis=0, cores=mp.cpu_count())
