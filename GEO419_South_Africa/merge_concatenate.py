...
def main():
    ...
    # Input file name
    raster_filename = "S1_A_VH_agulhas_full_study_site_50m_edge.tif"
    ...
    # Output File Name:
    output_file = raster_filename + "_peak_detect25.tif"
#simple_edge_detection
    ...
    # filtered_arr = apply_along_axis.parallel_apply_along_axis(func1d=filter_functions.simple_edge_detection2, arr=arr, axis=0, cores=mp.cpu_count())
    ...
    result = apply_along_axis.parallel_apply_along_axis(func1d=function.find_peaks, arr=arr, axis=0, cores=mp.cpu_count())
